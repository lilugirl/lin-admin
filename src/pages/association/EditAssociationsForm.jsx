...
const EditAssociationsForm = () => {
  ...
  return (
    <div className="Edit_Association">
      <form onSubmit={handleSubmit}>
        <div className="new_title">{t("associationsRegistrationForm.edittitle")}</div>
        ...
        <div className="Register_association_submit_btn">
          <button type="submit" value="Submit">
            {t("associationsRegistrationForm.update")}
          </button>
        </div>
      </form>
    </div>
...
export default EditAssociationsForm;
