...
const EditCreateGroupProfile = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await fetch("/data/groupProfile.json");
  ...
  return (
    <div className="create-group-profile">
      <form onSubmit={handleSubmit}>
        <div className="new_title">{t("createGroupProfile.editProfileTitle")}</div>
...
export default EditCreateGroupProfile;
